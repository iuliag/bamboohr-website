...
export function offloadMartech() {
    ...
    // createScriptElement(document.body, getAdobeTagsSrc(), SCRIPT_TYPE_PARTYTOWN);
    ...
    window.partytown = {
        ...
        // globalFns: ['s_gi', 'AppMeasurement', 's', '_satellite', 'aaPlugins', 'bhr', '_wq', 'getTimeParting', 'digitalData',
        // 'adobeDataLayer'],
